 ...
 */
public class ClothingWithValidation {
    ...
    private ClothingWithValidation(ClothingWithValidationBuilder builder) throws ValidationError {
        this.id = builder.id;
    ...
    public void validate() throws ValidationError {
        ...
        Set<ConstraintViolation<ClothingWithValidation>> violations = validator.validate(this);
        if (!violations.isEmpty()) {
            StringBuilder allErrorMessages = new StringBuilder();
            for (ConstraintViolation<ClothingWithValidation> violation : violations)
            {
    ...
    public static class ClothingWithValidationBuilder{
        ...
        public ClothingWithValidation build() throws ValidationError {
            return new ClothingWithValidation(this);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        ClothingWithValidation clothing = (ClothingWithValidation) o;
    ...
    public ClothingWithValidation(LinkedHashMap<String, Object> clothing) {
        try {
